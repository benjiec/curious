...
function make_filter(column_index){function _lc(s){if(typeof s==='string'){return s.toLowerCase();}return s;}
...
function update_controller(){ set_table_cb({queries:tbl_queries,attrs:tbl_attrs,length:tbl_rows.length,view:tbl_view,controls:tbl_controls,csv:tbl_csv, toggleQuery:toggle,showCSV:show_csv,nextPage:next_page,prevPage:prev_page,sort:sort,make_filter:make_filter,filter:filter,});}
