...
for(var col=1;col<query_results.length;col++){console.log(query_results[col]);var new_entries=[];var column=query_results[col];var join_index=column.join_index;for(var i=0;i<entries.length;i++){var row=entries[i];var objs=undefined;if(row[join_index]!==null){var join_pk=row[join_index].id;objs=column.map[join_pk];}
