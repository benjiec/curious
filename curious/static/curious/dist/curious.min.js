...
function curiousJoinTable(results,set_table_cb,object_cache_f,get_objects_f){
 ...
 var GET_BATCH=300; var DEFAULT_PAGE_SIZE=100;var PARTIAL_FETCH=3000; var entries;var models;var left_join_mode;var tbl_attrs;var tbl_rows;var tbl_view;var tbl_csv;var tbl_controls;var partial_fetch;var pourover_collection;var outstanding_fetches; var object_cache=object_cache_f();function process_results(lj){left_join_mode=lj;entries=[];models=[];tbl_attrs=[];tbl_rows=[];tbl_view=undefined;tbl_csv=undefined;tbl_controls={};partial_fetch=undefined;pourover_collection=undefined;outstanding_fetches=0;
...
for(var i=0;i<results[0].objects.length;i++){entries.push([build_obj(0,results[0].objects[i])]);} 
