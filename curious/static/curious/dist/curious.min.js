...
function curiousJoinTable(results,set_table_cb,object_cache_f,get_objects_f){
 ...
 var GET_BATCH=500; var DEFAULT_PAGE_SIZE=100;var AUTO_FETCH_THRESHOLD=100; var entries=[];var models=[]; var tbl_queries=[];var tbl_attrs=[];var tbl_rows=[];var tbl_view=undefined;var tbl_csv=undefined;var tbl_controls={};var pourover_collection=undefined;var pourover_sorters=undefined;var outstanding_fetches=0; var object_cache=object_cache_f();
...
tbl_view=new PourOver.View('default',pourover_collection,{page_size:page_size});tbl_controls={fetched:true};}
...
function make_filter(column_index){ if(outstanding_fetches>0){return;}
