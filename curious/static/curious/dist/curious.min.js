...
$scope.checkQuery=function(cb){if($scope.query!=''){console.log('checking '+$scope.query+'.');$scope._check_query($scope.query,function(query_string,err){$scope.query_error=err;$scope.query_accepted=query_string;if(cb!==undefined){cb(query_string,err);}});}};$scope.submitQuery=function(reload){if(reload===undefined){reload=false;}
